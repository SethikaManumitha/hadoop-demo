...
HDFS_OUTPUT="/user/test/output/MapReduce/DistrictPerMonth"
...
sudo docker exec -it $DOCKER_CONTAINER bash -c "
    ...
    yarn jar $HADOOP_TARGET_PATH/MapReduce-1.0-SNAPSHOT.jar org.sethika.DistrictPerMonth $HDFS_INPUT $HDFS_OUTPUT
